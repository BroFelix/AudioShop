...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[0] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.green, width: 1.0),
                    ),
                    child: Text(
                      'Popularity',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[1] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.grey, width: 1.0),
                    ),
                    child: Text(
                      'Newest',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[2] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.grey, width: 1.0),
                    ),
                    child: Text(
                      'Oldest',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[3] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.grey, width: 1.0),
                    ),
                    child: Text(
                      'High Price',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[4] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.grey, width: 1.0),
                    ),
                    child: Text(
                      'Low Price',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12.0),
                      border: !_sortSelected[5] ? Border.all(color: AppColors.grey, width: 1.0) : Border.all(color: AppColors.grey, width: 1.0),
                    ),
                    child: Text(
                      'Reapp',
  ...
  Widget _tabScrollapp() => SingleChildScrollView(
        padding: EdgeInsets.only(left: 18.0),
