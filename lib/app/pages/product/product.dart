...
import 'package:audioshop/app/widgets/comment.dart';
import 'package:audioshop/app/widgets/green_button.dart';
import 'package:audioshop/app/widgets/line_decoration.dart';
                ...
                child: TabBarView(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      width: constraints.maxWidth,
                      child: ListView(
                        padding: EdgeInsets.only(left: 24.0, top: 4.0, right: 24.0),
                        primary: false,
                        children: [
                          Text(
          ...
          Column(
            ...
            children: [
              ...
              SizedBox(
                width: 395.w,
                child: Text(
                  'The Aptx® HD codec transmits 24-bit hi-app/res audio, equal to or better than CD quality.',
                  style: AppTextStyle.title,
