...
import 'package:audioshop/app/widgets/bottom_sheet.dart';
import 'package:audioshop/app/widgets/product_view.dart';
              ...
              child: Container(
                ...
                child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2,
                    mainAxisExtent: constraints.maxHeight > 700 ? 320.h : 350.h,
                    mainAxisSpacing: 16.0,
                    crossAxisSpacing: 16.0,
                  ),
                  itemCount: 3,
                  itemBuilder: (BuildContext context, int index) => Productapp(
                    onPressed: () {
                      appState.push(PageAction(
                        state: PageState.push,
                        page: detailConfig,
